...
public class RecommendedAdapterFull extends RecyclerView.Adapter<RecommendedAdapterFull.MyViewHolder> {
    private Recommendations recommendations;
    private View view;
    private onItemListener onItemListener;

    public RecommendedAdapterFull() {
...
//    public void setOnItemListener(RecommendedAdapterFull.onItemListener onItemListener) {
